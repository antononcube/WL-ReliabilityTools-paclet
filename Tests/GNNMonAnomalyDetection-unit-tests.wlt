...
(*BeginTestSection["GNNMonAnomalyDetection-unit-tests.wlt"];*)
...
(* Test 4 *)
VerificationTest[
  GNNMonAnomalyDetection[trainingData, testingData, "Anomalies"],
  $Failed,
...
(* Test 5 *)
VerificationTest[
  GNNMonAnomalyDetection[trainingData[[All, 2]], testingData[[All, 2]], "AnomalyCount"],
  _Integer,
  SameTest -> MatchQ,
...
(* Test 8 *)
VerificationTest[
  GNNMonAnomalyDetection[trainingData[[All, 2]], testingData[[All, 2]], "Anomalies"],
  _List,
  SameTest -> MatchQ,
...
(* Test 10 *)
VerificationTest[
  gnnObj = GNNMonAnomalyDetector[trainingData[[All, 2]]],
  Blank[AntonAntonov`MonadicGeometricNearestNeighbors`GNNMon],
  SameTest -> MatchQ,
  TestID -> "AnomalyDetector-call-1"
];

(* Test 11 *)
VerificationTest[
  GNNMonAnomalyDetector[trainingData[[All, 2]], testingData[[All, 2]], "Anomalies"],
  $Failed,
  {GNNMonAnomalyDetector::noargs},
  TestID -> "AnomalyDetector-call-2"
];

(* Test 12 *)
VerificationTest[
  GNNMonAnomalyDetection[gnnObj, testingData[[All, 2]], "Anomalies"] == GNNMonAnomalyDetection[trainingData[[All, 2]], testingData[[All, 2]], "Anomalies"],
  True,
  TestID -> "AnomalyDetector-equivalence"
];
